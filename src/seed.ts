...
export const seedTasks: SprintTask[] = [
  ...
  t('w2-mon-a', 2, W2[0], 'Mon', '13:00', '14:30', 'a',
    ...
    'MSA (Master Services Agreement) = umbrella contract governing the whole client relationship. SOW (Statement of Work) = per-engagement scope. SOW must include: fixed price, scope deliverables, payment terms (50% on signature / 50% on UAT), per-engagement liability cap = fees paid (§11), and the v0.4 AI disclosure language: "Deliverables are produced using AI tooling and reviewed by Tack for source-traceability and internal consistency. Clients are responsible for validating numerical claims against their own systems before acting on recommendations." Get a tech E&O insurance quote in parallel (about $400 to $800/yr).'),
